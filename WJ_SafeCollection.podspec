...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wanjiehuizhaofang/WJ_SafeCollection'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wanjiehuizhaofang' => 'wanjie@huizhaofang.com' }
  s.source           = { :git => 'https://github.com/wanjiehuizhaofang/WJ_SafeCollection.git', :tag => s.version.to_s }
