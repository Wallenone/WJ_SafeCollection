...
//  Array
//
//  Created by wallen on 17/5/27.
//  Copyright © 2017 wallen. All rights reserved.
//

#import "WJ_SafeCollection.h"
...
void fcxSafeCollectionLog(NSString *fmt, ...)
{
   ...
   // NSLog(@"***Terminating app due to uncaught exception\n");
    ...
    //[NSString stringWithFormat:@"***reason:-%@/n,*** First throw call stack:\n%@",content,[NSThread callStackSymbols]]
    
    UIAlertView * alertView = [[UIAlertView alloc] initWithTitle:nil message:[NSString stringWithFormat:@"***reason:-%@",content] delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    [alertView show];
...
@implementation WJ_SafeCollection
